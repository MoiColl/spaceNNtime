...
for i in range(len(experiments)):
	...
	gwf.target_from_template("sNNt_{}_{}_{}".format(experiments["sim"][i],       experiments["exp"][i],       experiments["nam"][i]), 
							  spaceNNtime_sim(sim = experiments["sim"][i], exp = experiments["exp"][i], nam = experiments["nam"][i], 
							                  met = experiments["met"][i], siz = experiments["siz"][i], snp = experiments["snp"][i], 
											  pre = experiments["pre"][i], typ = experiments["typ"][i], cov = experiments["cov"][i], 
											  err = experiments["err"][i], nod = experiments["nod"][i], mem = experiments["mem"][i], 
											  que = experiments["que"][i], tim = experiments["tim"][i]))